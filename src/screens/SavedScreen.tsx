...
function SavedItem({
  item,
  onRemove,
}: SavedItemProps): React.JSX.Element {
  return (
    <View style={styles.card}>
      ...
      <View style={styles.cardContent}>
        ...
        <Text
          ...
          numberOfLines={1}
        >
          {item.modality} · {item.duration} semanas
        </Text>
      </View>
      ...
      <Pressable
        ...
        onPress={onRemove}
        accessibilityLabel={`Quitar ${item.name} de mis proyectos`}
      >
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Ve a Proyectos, selecciona uno y guárdalo
              para verlo aquí.
            </Text>
          </View>
        }
