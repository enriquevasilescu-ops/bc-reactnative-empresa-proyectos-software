...
function HomeStackNavigator(): React.JSX.Element {
  return (
    ...
    >
      {/* Pantalla inicial del Stack — lista de proyectos */}
      <HomeStack.Screen
        name="HomeList"
      ...
      <HomeStack.Screen
        ...
        // El título se lee dinámicamente desde los params (nombre del proyecto)
...
export function RootNavigator(): React.JSX.Element {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        // Íconos que cambian según la pestaña activa (focused)
